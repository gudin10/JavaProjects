 ...
 * @author carlo
 */
public class Caculadoragrafic extends javax.swing.JFrame {

    public float num1,num2;
    public String operador;
    
    public Caculadoragrafic() {
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        switch(this.operador){
            case "+": this.casilla.setText(Float.toString(this.num1+this.num2));
            break;
            case "-": this.casilla.setText(Float.toString(this.num1-this.num2));
            break;
            case "*": this.casilla.setText(Float.toString(this.num1*this.num2));
            break;
            case "/":
                if(this.num2==0) {this.casilla.setText("no se puede dividir entre 0");}else{
                    this.casilla.setText(Float.toString(this.num1/this.num2));
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Caculadoragrafic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Caculadoragrafic().setVisible(true);
            }
        });
    }
